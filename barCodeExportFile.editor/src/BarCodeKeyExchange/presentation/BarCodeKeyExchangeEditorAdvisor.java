 ...
 * @generated
 */
public final class BarCodeKeyExchangeEditorAdvisor extends WorkbenchAdvisor {
	/**
	 ...
	 * @generated
	 */
	private static final String[] FILE_EXTENSION_FILTERS = BarCodeKeyExchangeEditor.FILE_EXTENSION_FILTERS.toArray(new String[0]); 
	...
	private static String getString(String key, Object s1) {
		return BarCodeKeyExchange.presentation.BarCodeKeyExchangeEditorPlugin.INSTANCE.getString(key, new Object [] { s1 });
	}
	...
	public static class Perspective implements IPerspectiveFactory {
		 ...
		 * @generated
		 */
		public static final String ID_PERSPECTIVE = "BarCodeKeyExchange.presentation.BarCodeKeyExchangeEditorAdvisorPerspective";
	...
	public static class WindowAdvisor extends WorkbenchWindowAdvisor {
		...
		public void postWindowOpen() {
			...
			//remove general preferences page
			PreferenceManager pm = PlatformUI.getWorkbench( ).getPreferenceManager();
			
			IPreferenceNode networkNode = pm.find("org.eclipse.ui.preferencePages.Workbench/org.eclipse.ui.net.NetPreferences"); 
			if (networkNode != null) {
				pm.addToRoot(networkNode);
			}
			
			IPreferenceNode securityNode = pm.find("org.eclipse.ui.preferencePages.Workbench/org.eclipse.equinox.security.ui.category"); 
	...
	public static class WindowActionBarAdvisor extends ActionBarAdvisor {
		...
		protected IMenuManager createFileMenu(IWorkbenchWindow window) {
			...
			menu.add(new Action("Load UIC public keys..."){								
	    ...
	    protected void fillCoolBar(ICoolBarManager coolBar) {
	    	...
	    	toolBarX.add(this.getAction("new"));
	    	toolBarX.add(this.getAction("save"));
	    	toolBarX.add(this.getAction("saveAs"));	 	    	
	    	toolBarX.add(this.getAction("redo"));
	    	toolBarX.add(this.getAction("undo"));	    	
	    	coolBar.add(new ToolBarContributionItem(toolBarX,IWorkbenchActionConstants.TOOLBAR_FILE));
	    }
	}
	...
	/**
	 * Open action for the objects from the BarCodeKeyExchange model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * Open URI action for the objects from the BarCodeKeyExchange model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
