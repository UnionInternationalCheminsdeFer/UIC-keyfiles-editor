...
public class ExportCertificateToPemAction extends BaseSelectionListenerAction {
	


	public ExportCertificateToPemAction(String text)
	{
		super(text);
		this.setText(LocalLanguageSupport._Action_ExportCertificateKeyAsPemFile);
